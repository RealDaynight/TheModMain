...
public class AdventureChestGUIScreen extends AbstractContainerScreen<AdventureChestGUIMenu> {
	private final static HashMap<String, Object> guistate = AdventureChestGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public AdventureChestGUIScreen(AdventureChestGUIMenu container, Inventory inventory, Component text) {
