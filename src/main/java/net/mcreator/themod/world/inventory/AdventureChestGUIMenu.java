...
package net.mcreator.themod.world.inventory;
...
import net.mcreator.themod.init.ThemodModMenus;

import java.util.function.Supplier;
import java.util.Map;
import java.util.HashMap;

public class AdventureChestGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AdventureChestGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ThemodModMenus.ADVENTURE_CHEST_GUI, id);
